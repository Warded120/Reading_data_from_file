...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(470, 10, 100, 25));
        infobox = new QLineEdit(centralwidget);
        infobox->setObjectName("infobox");
        infobox->setGeometry(QRect(10, 10, 450, 25));
        result = new QLabel(centralwidget);
        result->setObjectName("result");
        result->setGeometry(QRect(580, 8, 401, 25));
        QFont font;
        ...
        textEdit->setGeometry(QRect(10, 40, 700, 500));
